...
{
    LOGD("AudioHardware setfmvolume to %f",v);
#define HAVE_BCM_FM_RADIO
...
#else
    //added by ioz9,2012-03-23
    //float ratio = 2.5;
    //int volume = (unsigned int)(AudioSystem::logToLinear(v) * ratio);
    unsigned int VolValue = (unsigned int)(AudioSystem::logToLinear(v));
    int volume = (unsigned int)(VolValue*VolValue/75);
#endif
    ...
    //fix hci cmd for fm volume control, by zhoujun 2012/05/30
    char volreg[100] = "hcitool cmd 0x3f 0x15 0xf8 0x00 ";
#endif
    ...
    //system("hcitool cmd 0x3f 0x15 0x5 0xc0 0x41 0xf 0 0x20 0 0 0");
    //system("hcitool cmd 0x3f 0x15 0x5 0xe4 0x41 0xf 0 0x00 0 0 0");
    //LOGD("VOLREG: %s",volreg);
    system(volreg);
#endif
